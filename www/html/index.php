...
<div class="flex flex-col items-center space-y-3">
    ...
    <a class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" href="login.php"><?= $jePrihlaseny ? "Přidejte plány do oblíbených": "Nebo se přihlašte aby jste mohli dávat cvičení plány do oblíbených" ?></a>
</div>
<?php
